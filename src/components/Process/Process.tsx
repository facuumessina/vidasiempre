...
// Íconos SVG como componentes de ejemplo. Puedes usar una librería o SVGs personalizados.
...
const Process: React.FC = () => {
    return (
        <section className={styles.processSection}>
            <h2 className={styles.mainTitle}>Simple, único y para toda la vida</h2>
            <div className={styles.stepsContainer}>
                <div className={styles.step}>
                    <div className={styles.iconWrapper}><IconExplore /></div>
                    <h3 className={styles.stepTitle}>Explorá</h3>
                    <p className={styles.stepText}>Descubrí nuestras colecciones y encontrá la pieza que resuena con tu estilo.</p>
                </div>
                <div className={styles.step}>
                    <div className={styles.iconWrapper}><IconChoose /></div>
                    <h3 className={styles.stepTitle}>Elegí</h3>
                    <p className={styles.stepText}>Seleccioná tu diseño favorito y hacé tu pedido de forma segura a través de nuestra tienda.</p>
                </div>
                <div className={styles.step}>
                    <div className={styles.iconWrapper}><IconDecorate /></div>
                    <h3 className={styles.stepTitle}>Decorá</h3>
                    <p className={styles.stepText}>Recibí tu pieza artesanal y dale a tu espacio un toque de diseño que perdura.</p>
                </div>
            </div>
        </section>
    );
